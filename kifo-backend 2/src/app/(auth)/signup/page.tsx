    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={{textAlign:"center",padding:"1rem 0"}}>
          ...
          <p style={{fontSize:"0.88rem",color:"#9E8C7A"}}>We sent a confirmation link to <strong>{email}</strong>.<br/>Click it to activate your account.</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>Start with a free memorial — no credit card needed</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.field}>
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)}
              style={styles.input} placeholder="8+ characters" minLength={8} required />
          </div>
          ...
          <p style={{fontSize:"0.72rem",color:"#C8BFB0",textAlign:"center",marginTop:"0.75rem"}}>
            By signing up you agree to our <Link href="/about" style={{color:"#C4714F"}}>Terms</Link> &amp; <Link href="/about" style={{color:"#C4714F"}}>Privacy Policy</Link>
          </p>
        </form>
